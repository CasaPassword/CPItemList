...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/CasaPassword/CPItemList"
  ...
  s.source       = { :git => "https://bitbucket.org/casapirate/cpitemlist.git", :tag => s.version.to_s }
  ...
  s.source_files  = "CPItemList/CPItemList/**/*.{h,m}"
  ...
  s.dependency "CPDataCenter"
  s.dependency "CPCategories"
